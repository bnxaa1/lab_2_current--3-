...
//lpm_counter DEVICE_FAMILY="Cyclone V" lpm_direction="UP" lpm_port_updown="PORT_UNUSED" lpm_width=12 clock q sclr
...
`endif
	...
	assign
		wire_counter_reg_bit_asdata = (({12{sset}} & s_val) | ({12{(~ sset)}} & data)),
		wire_counter_reg_bit_d = {wire_counter_comb_bita_11sumout[0:0], wire_counter_comb_bita_10sumout[0:0], wire_counter_comb_bita_9sumout[0:0], wire_counter_comb_bita_8sumout[0:0], wire_counter_comb_bita_7sumout[0:0], wire_counter_comb_bita_6sumout[0:0], wire_counter_comb_bita_5sumout[0:0], wire_counter_comb_bita_4sumout[0:0], wire_counter_comb_bita_3sumout[0:0], wire_counter_comb_bita_2sumout[0:0], wire_counter_comb_bita_1sumout[0:0], wire_counter_comb_bita_0sumout[0:0]};
	assign
		wire_counter_reg_bit_ena = {12{(clk_en & (((cnt_en | sclr) | sset) | sload))}},
		wire_counter_reg_bit_sload = {12{(sset | sload)}};
...
endmodule //twelveBitsCounter_cntr
//VALID FILE
...
module twelveBitsCounter (
	...
	twelveBitsCounter_cntr	twelveBitsCounter_cntr_component (
				.clock (clock),
				.sclr (sclr),
				.q (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL twelveBitsCounter.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL twelveBitsCounter.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL twelveBitsCounter.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL twelveBitsCounter.bsf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL twelveBitsCounter_inst.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL twelveBitsCounter_bb.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL twelveBitsCounter_syn.v TRUE
